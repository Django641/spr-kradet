...
tittel: Å eller og
kilde: Språkrådet
url: https://sprakradet.no/godt-og-korrekt-sprak/rettskriving-og-grammatikk/a-eller-og/
sist_endret: 2024-08-29
hentet: 2026-09-02
...
Også uttrykk med presens partisipp fulgt av infinitiv skrives med **og**:  
  
"De ble liggende og prate.  
...
Vil vi understreke at den første handlingen har et formål, kan vi også skrive «De ville *dra for* å handle» osv., men oftest er det best å bruke *og* uten *for*. Uttrykkene **være med** (**på) å** og **være med** **og** er omtalt i [svarbasen](https://sprakradet.no/spraksporsmal-og-svar/vaere-med-og-eller-a/) vår.
...
Utrykk som **komme ut å kjøre** og **være ute å kjøre** skal ikke leses bokstavelig. Det handler ikke om å være ute på veien og kjøre. Dette er stivnede uttrykk med den overførte betydningen ‘oppleve vanskeligheter’. Her bruker vi infinitivsmerket **å**:   
